...
impl MovieSimilarityApp {
    fn load_movies(&mut self, path: &Path) -> Result<(), Box<dyn std::error::Error>> {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            if !self.movies.is_empty() {
                ...
                if let Some(selected_idx) = self.selected_movie_index {
                    ...
                    ui.add_space(10.0);
                    ui.heading("Top 5 Similar Movies:");
                    ...
                    while count < 5 && index < similar_indices.len() {
